...
export const translations = {
  th: {
    ...
    doctorSearch: "ค้นหาแพทย์",
    doctorSearchPlaceholder: "พิมพ์ชื่อแพทย์หรือความเชี่ยวชาญ",
    noDoctorSearchResults: "ไม่พบแพทย์ที่ค้นหา",
    nextClinic: "รอบถัดไป",
    noClinicThisWeek: "ยังไม่มีตารางออกตรวจในสัปดาห์นี้",
  ...
  en: {
    ...
    doctorSearchPlaceholder: "Type a doctor name or specialty",
    noDoctorSearchResults: "No doctors match your search",
    nextClinic: "Next clinic",
    noClinicThisWeek: "No clinic schedule this week",
